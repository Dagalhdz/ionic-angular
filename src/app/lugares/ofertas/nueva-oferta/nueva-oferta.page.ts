...
export class NuevaOfertaPage implements OnInit {
  ...
  form: FormGroup;
  constructor(private lugaresServices: LugaresService, private router: Router) { }
  ...
  onCreateOffer(){
    ...
    this.lugaresServices.addLugar(this.form.value.titulo, this.form.value.descripcion, +this.form.value.precio, new Date(this.form.value.Desde), new Date(this.form.value.hasta), this.form.value.ubicacion);
    this.form.reset();
